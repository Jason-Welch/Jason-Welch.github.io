...
const tracks = [
    ...
    {trackId: "../Music/【imase】NIGHT_DANCER（MV）(256k).mp3", title: "【imase】NIGHT_DANCER"}
];
...
const humburgerMenuContainerTag = document.querySelector(".humburgerMenuContainer");
...
overlayMenuTag.style.bottom = `-${overlayMenuTag.offsetHeight}px`
...
humburgerMenuContainerTag.addEventListener("click", () => {
    if (humburgerMenuContainerTag.classList.contains("isOpened")) {
        ...
        overlayMenuTag.style.bottom = `0px`;
    }
});